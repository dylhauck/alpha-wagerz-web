...
function QuarterbackRow({
  ...
  return (
    <div className="grid gap-2 rounded-2xl border border-white/10 bg-white/[0.025] p-3 lg:grid-cols-[minmax(190px,1.5fr)_repeat(6,minmax(90px,1fr))]">
      <div>
...
function SkillPlayerRow({
  ...
  return (
    <div className="grid gap-2 rounded-2xl border border-white/10 bg-white/[0.025] p-3 lg:grid-cols-[minmax(190px,1.5fr)_repeat(7,minmax(82px,1fr))]">
      <div>
        <div className="font-black text-white">
          {getPlayerName(player)}
        </div>
