...
const SLATE_PATH = "/data/nfl/next/slate.json";
const PROJECTION_PATH = "/data/nfl/next/game_projections.json";
const MARKET_PATH = "/data/nfl/next/market.json";
const PAGE_TITLE = "Next Slate";
