...
function SortableHeader({
  ...
  return (
    <button
      ...
      className={`group flex w-full items-center gap-1.5 text-[10px] font-black uppercase tracking-[0.1em] transition ${
        align === "left"
    ...
    >
      ...
      {active ? (
        ...
        <ChevronsUpDown
          size={12}
          className="shrink-0 opacity-35 transition group-hover:opacity-80"
        />
      )}
    </button>
  );
    ...
    <div className="flex items-center gap-2">
      <div className="flex h-[30px] w-[30px] shrink-0 items-center justify-center">
        {logoUrl ? (
          ...
          <div className="flex h-[30px] w-[30px] items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-[9px] font-black text-slate-500">
            {team || "—"}
          </div>
        )}
      </div>
    ...
    <div className="flex items-center justify-center gap-2">
      <div className="flex h-[26px] w-[26px] shrink-0 items-center justify-center">
        {logoUrl ? (
          <img
            src={logoUrl}
            alt={`${opponent || "NFL"} logo`}
            width={26}
            height={26}
            className="h-[26px] w-[26px] object-contain"
          />
        ) : (
          <div className="flex h-[26px] w-[26px] items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-[8px] font-black text-slate-500">
            {opponent || "—"}
          </div>
        )}
      </div>
