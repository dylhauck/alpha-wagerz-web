    ...
    <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-4">
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        <div>
          ...
          <StatCell value={pitcher["Pitch Score"]} statKey="Pitch Score" />
        </div>
...
export function SelectedGameDashboard({ game }: { game: Record<string, any> }) {
  ...
  const awayPitcher = game?.pitchers?.find((p: any) => p.Team === game.away_team);
  const homePitcher = game?.pitchers?.find((p: any) => p.Team === game.home_team);
  ...
  {game.game}
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <div className="rounded-3xl border border-cyan-300/20 bg-cyan-300/10 p-4">
            ...
            <div className="mt-2">
              <StatCell value={awayTop?.Likely} statKey="Likely" />
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-pink-300/20 bg-pink-500/10 p-4">
            ...
            <div className="mt-2">
              <StatCell value={homeTop?.Likely} statKey="Likely" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-4 xl:grid-cols-3">
        <div className="glass rounded-3xl p-4">
          <h2 className="mb-3 text-lg font-black text-white">Weather Edge</h2>
        ...
        <div className="glass rounded-3xl p-4">
          <h2 className="mb-3 text-lg font-black text-white">Away Starter</h2>
          <PitcherCard pitcher={awayPitcher} />
        </div>

        <div className="glass rounded-3xl p-4">
          <h2 className="mb-3 text-lg font-black text-white">Home Starter</h2>
          <PitcherCard pitcher={homePitcher} />
        </div>
      </section>
